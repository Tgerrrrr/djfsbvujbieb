...
public class Kasir {
    ...
    public void hapusPelanggan(int nomorMeja) {
        if (nomorMeja >= 1 && nomorMeja <= daftarMeja.length) {
            ...
            System.out.println("Pelanggan dari Meja " + nomorMeja + " telah dihapus");
        } else {
            System.out.println("Nomor meja tidak valid");
        }
    }
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    // EDIT DISINI
                    System.out.print("Nomer meja: ");
                    int nomerMejaTambah = scanner.nextInt();
                    scanner.nextLine();
                    System.out.print("Nama Pelanggan: ");
                    String namaPelanggan = scanner.nextLine();
                    Pelanggan pelanggan = new Pelanggan(namaPelanggan);
                    tambahPelanggan(nomerMejaTambah, pelanggan);
                    break;
                case 3:
                ...
                case 5:
                    ...
                    // total harga 0
                    // EDIT DISINI
                    System.out.print("Masukkan nomor meja untuk menghitung harga pesanan: ");
